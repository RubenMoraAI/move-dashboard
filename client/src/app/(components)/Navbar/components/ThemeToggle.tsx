...
const ThemeToggle  = ({ isDarkMode, toggleDarkMode }:ThemeToggleProps) => {
  return (
    <button
      ...
      className={`relative w-14 h-8 border-2 focus:outline-none border-indigo-500 flex items-center bg-gray-200 dark:bg-gray-700 rounded-full transition-colors duration-300`}
    >
      <div
