...
const Sidebar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col ${isSidebarCollapsed ? 'w-0 md:w-16' : 'w-72 md:w-64'
    } bg-white dark:bg-slate-800 transition-all duration-300 overflow-hidden h-full shadow-md z-40`;
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      >
        ...
        <button
          className="md:hidden px-3 py-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-indigo-100"
      ...
      {!isSidebarCollapsed && (
        <div className="mb-6 px-8">
          <Link
            href="/Premium"
            className="flex items-center justify-center gap-3 w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white py-3 rounded-lg font-bold text-lg shadow-md hover:shadow-lg hover:scale-105 transition transform"
          >
